...
func demoStubPie(_ *gui.Window) gui.View {
	return chart.Pie(chart.PieCfg{
...
func demoStubDonut(_ *gui.Window) gui.View {
	return chart.Pie(chart.PieCfg{
		BaseCfg: chart.BaseCfg{
			ID:     "pie-donut",
...
func demoStubArea(_ *gui.Window) gui.View {
	return chart.Area(chart.AreaCfg{
		BaseCfg: chart.BaseCfg{
			ID:     "area-basic",
			Title:  "User Signups",
			Sizing: gui.FillFixed,
...
func demoStubAreaStacked(_ *gui.Window) gui.View {
	return chart.Area(chart.AreaCfg{
		BaseCfg: chart.BaseCfg{
			ID:     "area-stacked",
...
func demoStubScatter(_ *gui.Window) gui.View {
	return chart.Scatter(chart.ScatterCfg{
		BaseCfg: chart.BaseCfg{
			ID:     "scatter-basic",
...
func demoStubScatterMarkers(_ *gui.Window) gui.View {
	return chart.Scatter(chart.ScatterCfg{
		BaseCfg: chart.BaseCfg{
			ID:     "scatter-markers",
